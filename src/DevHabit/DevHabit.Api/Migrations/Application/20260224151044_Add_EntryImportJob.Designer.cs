...
namespace DevHabit.Api.Migrations.Application
{
    ...
    [Migration("20260224151044_Add_EntryImportJob")]
    partial class Add_EntryImportJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.EntryImportJob", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.ToTable("entry_import_jobs", "dev_habit");
                });
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.HabitTag", b =>
                {
                    ...
                    b.Property<string>("HabitId1")
                        .HasColumnType("character varying(500)")
                        .HasColumnName("habit_id1");

                    b.HasKey("HabitId", "TagId")
                        .HasName("pk_habit_tags");

                    b.HasIndex("HabitId1")
                        .HasDatabaseName("ix_habit_tags_habit_id1");
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.Habit", b =>
                {
                    ...
                    b.OwnsOne("DevHabit.Api.Entities.Frequancy", "Frequancy", b1 =>
                        {
                            ...
                            b1.Property<int>("TimesPerPeriod")
                                .HasColumnType("integer")
                                .HasColumnName("frequancy_times_per_period");

                            b1.Property<int>("Type")
                                .HasColumnType("integer")
                                .HasColumnName("frequancy_type");
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.HabitTag", b =>
                {
                    ...
                    b.HasOne("DevHabit.Api.Entities.Habit", null)
                        ...
                        .HasConstraintName("fk_habit_tags_habits_habit_id1");
