...
public sealed class TokenProviderTests
{
    ...
    public void Create_ShouldReturnAccessTokens()
    {
        ...
        // Act
        AccessTokenDto accessTokensDto = _sut.Create(dto);
    ...
    public void Create_ShouldGenerateUniqueRefreshTokens()
    {
        ...
        // Act
        AccessTokenDto accessTokensDto1 = _sut.Create(dto);
        AccessTokenDto accessTokensDto2 = _sut.Create(dto);
