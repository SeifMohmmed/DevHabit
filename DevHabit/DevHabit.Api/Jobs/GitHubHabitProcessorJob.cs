...
// Prevent concurrent execution for the same job
    ...
    ILogger<GitHubHabitProcessorJob> logger) : IJob
{
    ...
    {
        // Retrieve habitId passed from scheduler job
        ...
        try
        {
            ...
            // Load habit and ensure it is still valid and not archived
            ...
            // Retrieve stored GitHub access token for the user
            ...
            // Container for all fetched events
            ...
            {
                // Prevent duplicate entries using ExternalId
