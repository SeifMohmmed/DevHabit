...
public sealed class GitHubApiServer : IDisposable
{
    ...
    private static GitHubUserProfileDto GenerateGitHubUserProfile(string username) => new()
    {
        ...
        Id = 1,
        NodeId = "MDQ6VXNl1jE=",
        AvatarUrl = new Uri("https://avatars.githubusercontent.com/u/1?v=4"),
        GravatarId = "",
        Url = new Uri($"https://api.github.com/users/{username}"),
        HtmlUrl = new Uri($"https://github.com/{username}"),
        FollowersUrl = new Uri($"https://api.github.com/users/{username}/followers"),
        FollowingUrl = new Uri($"https://api.github.com/users/{username}/following{{/other_user}}"),
        GistsUrl = new Uri($"https://api.github.com/users/{username}/gists{{/gist_id}}"),
        StarredUrl = new Uri($"https://api.github.com/users/{username}/starred{{/owner}}{{/repo}}"),
        SubscriptionsUrl = new Uri($"https://api.github.com/users/{username}/subscriptions"),
        OrganizationsUrl = new Uri($"https://api.github.com/users/{username}/orgs"),
        ReposUrl = new Uri($"https://api.github.com/users/{username}/repos"),
        EventsUrl = new Uri($"https://api.github.com/users/{username}/events{{/privacy}}"),
        ReceivedEventsUrl = new Uri($"https://api.github.com/users/{username}/received_events"),
        Type = "User",
        SiteAdmin = false,
        Name = username,
        Company = "Test Company",
        Blog = new Uri($"https://{username}.dev"),
        Location = "Test City",
        ...
        Plan = new GitHubUserProfilePlanDto(
            Name: "pro",
            Space: 976562499,
            PrivateRepos: 9999,
            Collaborators: 0
